...
//! status in the log line too? See `examples/log_layer_broken.rs` for the
//! naive attempt at that, and `examples/log_layer_manual_poll.rs` /
//! `examples/log_layer.rs` for the two working fixes.
//!
